...
function success_info(){
    ...
    echo -e "# UserName1:$(__green " animekone")"
    echo -e "# UserName2:$(__green " lifengchi")"
    echo -e "# PassWord:$(__green " animekone")"
    echo -e "# PassXAUTH:$(__green " animekone")"
    echo -e "# PSK:$(__green " woshiluoqiang520")"
